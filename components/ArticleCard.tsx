      ...
      <Link href={`/post/${post.slug}`} className="group block min-h-[44px] min-w-[44px]">
        <div className="group/image relative w-full overflow-hidden bg-transparent">
          ...
          <img
            ...
            alt=""
            loading="lazy"
            className="card-img-mask-reveal block w-full h-auto transition-transform duration-500 ease-out group-hover/image:scale-105"
          />
        ...
        <div className={`group/title ${isLarge ? "mt-6 sm:mt-8" : "mt-4 sm:mt-6"}`}>
          <h2
            className={`max-w-fit font-black text-black leading-tight group-hover/title:underline ${
